...
import br.com.fiap.conexoes.ConexaoFactoy;
...
public class PacienteDAO {
    ...
    public PacienteDAO() throws SQLException, ClassNotFoundException, SQLException {
        this.minhaConexao = new ConexaoFactoy().conexao();
    }
